...
export declare class DataGrid extends Widget {
     ...
     */
    private _resizeCanvasIfNeeded(width, height);
    /**
     ...
     */
    private _setBaseSize(list, size);
    /**
     ...
     * This will update the scroll bars and repaint as needed.
     */
    private _resizeSection(list, index, size);
    /**
     * Hit test the grid headers for a resize handle.
     */
    private _hitTestResizeHandles(clientX, clientY);
    /**
     ...
     */
    private _blit(source, x, y, w, h, dx, dy);
    /**
