...
class OutputDiffModel extends renderable_1.RenderableDiffModel {
    ...
    hasMimeType(mimetype) {
        ...
        if (coreutils_1.nbformat.isStream(outputs) &&
            TEXT_MIMETYPES.indexOf(mimetype) !== -1) {
            return 'text';
        }
        else if (coreutils_1.nbformat.isError(outputs)) {
            return 'traceback';
        }
        else if (coreutils_1.nbformat.isExecuteResult(outputs) || coreutils_1.nbformat.isDisplayData(outputs)) {
