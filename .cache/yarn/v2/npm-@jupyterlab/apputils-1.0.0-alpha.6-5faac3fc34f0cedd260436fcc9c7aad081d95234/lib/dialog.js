...
(function (Dialog) {
    ...
    function prompt(prompt, defaultValue) {
        return showDialog({
            title: prompt,
            body: new PromptWidget(defaultValue),
     ...
     */
    class PromptWidget extends widgets_1.Widget {
        constructor(value) {
    ...
    class Renderer {
        ...
        createHeader(title) {
            ...
            if (typeof title === 'string') {
                ...
                header = vdom_1.ReactWidget.create(title);
            }
        ...
        createBody(value) {
            ...
            if (typeof value === 'string') {
                ...
                body = vdom_1.ReactWidget.create(value);
     ...
     */
    Dialog.tracker = new instancetracker_1.InstanceTracker({
