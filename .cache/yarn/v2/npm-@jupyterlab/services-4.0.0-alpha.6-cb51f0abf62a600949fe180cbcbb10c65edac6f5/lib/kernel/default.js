...
class DefaultKernel {
    ...
    shutdown() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield Private.shutdownKernel(this.id, this.serverSettings);
            yield this._clearState();
            this._clearSocket();
        });
    }
    ...
    _clearState() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield Promise.all(futuresResolved).catch(() => {
                /* no-op */
            });
        });
    }
...
(function (Private) {
    ...
    function restartKernel(kernel, settings) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield Promise.all(Private.runningKernels.filter(k => k.id === kernel.id).map(k => k.handleRestart()));
            let response = yield __1.ServerConnection.makeRequest(url, init, settings);
            if (response.status !== 200) {
                throw new __1.ServerConnection.ResponseError(response);
            }
